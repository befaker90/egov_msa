...
<title><%=System.getProperty("SERVER")%> - eGovFrame 공통 컴포넌트</title>
</head>
<body>
<div id="header">
	...
	<div style="margin-top:4px;"><strong class="top_title_strong"><%=System.getProperty("SERVER")%> - <spring:message code="comCmm.top.title"/></strong></div>
	</div>
</div>
</body>
</html>